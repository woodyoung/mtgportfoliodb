...
GO
ALTER TABLE [Codes].[Set] DROP CONSTRAINT [DF__Set__IsActive__5629CD9C];
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [Codes].[tmp_ms_xx_Set] ([SetId], [Code], [Name], [Description], [ReleaseDate], [BorderId], [MkmName], [MkmId], [CreatedBy], [CreatedOn], [UpdatedBy], [UpdatedOn], [IsActive])
        SELECT   [SetId],
                 [Code],
                 [Name],
                 [Description],
