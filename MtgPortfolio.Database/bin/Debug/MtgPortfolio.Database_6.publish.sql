...
GO
PRINT N'Creating [dbo].[MtgCardColors]...';


GO
CREATE TABLE [dbo].[MtgCardColors] (
    [MtgCardColorsId] INT          IDENTITY (1, 1) NOT NULL,
...
GO
PRINT N'Creating [dbo].[DF_MtgCard_IsTimeShifted]...';


GO
ALTER TABLE [dbo].[MtgCard]
    ADD CONSTRAINT [DF_MtgCard_IsTimeShifted] DEFAULT 0 FOR [IsTimeShifted];


GO
PRINT N'Creating [dbo].[DF_MtgCard_IsReserved]...';


GO
ALTER TABLE [dbo].[MtgCard]
    ADD CONSTRAINT [DF_MtgCard_IsReserved] DEFAULT 0 FOR [IsReserved];


GO
PRINT N'Creating [dbo].[DF_MtgCard_IsStarter]...';


GO
ALTER TABLE [dbo].[MtgCard]
    ADD CONSTRAINT [DF_MtgCard_IsStarter] DEFAULT 0 FOR [IsStarter];


GO
PRINT N'Creating [dbo].[DF_MtgCard_CreatedBy]...';


GO
ALTER TABLE [dbo].[MtgCard]
    ADD CONSTRAINT [DF_MtgCard_CreatedBy] DEFAULT (suser_name()) FOR [CreatedBy];


GO
PRINT N'Creating [dbo].[DF_MtgCard_CreatedOn]...';


GO
ALTER TABLE [dbo].[MtgCard]
    ADD CONSTRAINT [DF_MtgCard_CreatedOn] DEFAULT (getdate()) FOR [CreatedOn];


GO
PRINT N'Creating [dbo].[DF_MtgCard_UpdatedBy]...';


GO
ALTER TABLE [dbo].[MtgCard]
    ADD CONSTRAINT [DF_MtgCard_UpdatedBy] DEFAULT (suser_name()) FOR [UpdatedBy];


GO
PRINT N'Creating [dbo].[DF_MtgCard_UpdatedOn]...';


GO
ALTER TABLE [dbo].[MtgCard]
    ADD CONSTRAINT [DF_MtgCard_UpdatedOn] DEFAULT (getdate()) FOR [UpdatedOn];


GO
PRINT N'Creating [dbo].[DF_MtgCardColors_CreatedBy]...';


GO
ALTER TABLE [dbo].[MtgCardColors]
    ADD CONSTRAINT [DF_MtgCardColors_CreatedBy] DEFAULT (suser_name()) FOR [CreatedBy];


GO
PRINT N'Creating [dbo].[DF_MtgCardColors_CreatedOn]...';


GO
ALTER TABLE [dbo].[MtgCardColors]
    ADD CONSTRAINT [DF_MtgCardColors_CreatedOn] DEFAULT (getdate()) FOR [CreatedOn];


GO
PRINT N'Creating [dbo].[DF_MtgCardColors_UpdatedBy]...';


GO
ALTER TABLE [dbo].[MtgCardColors]
    ADD CONSTRAINT [DF_MtgCardColors_UpdatedBy] DEFAULT (suser_name()) FOR [UpdatedBy];


GO
PRINT N'Creating [dbo].[DF_MtgCardColors_UpdatedOn]...';


GO
ALTER TABLE [dbo].[MtgCardColors]
    ADD CONSTRAINT [DF_MtgCardColors_UpdatedOn] DEFAULT (getdate()) FOR [UpdatedOn];


GO
PRINT N'Creating [dbo].[DF_MtgCardLegalities_CreatedBy]...';


GO
ALTER TABLE [dbo].[MtgCardLegalities]
    ADD CONSTRAINT [DF_MtgCardLegalities_CreatedBy] DEFAULT (suser_name()) FOR [CreatedBy];


GO
PRINT N'Creating [dbo].[DF_MtgCardLegalities_CreatedOn]...';


GO
ALTER TABLE [dbo].[MtgCardLegalities]
    ADD CONSTRAINT [DF_MtgCardLegalities_CreatedOn] DEFAULT (getdate()) FOR [CreatedOn];


GO
PRINT N'Creating [dbo].[DF_MtgCardLegalities_UpdatedBy]...';


GO
ALTER TABLE [dbo].[MtgCardLegalities]
    ADD CONSTRAINT [DF_MtgCardLegalities_UpdatedBy] DEFAULT (suser_name()) FOR [UpdatedBy];


GO
PRINT N'Creating [dbo].[DF_MtgCardLegalities_UpdatedOn]...';


GO
ALTER TABLE [dbo].[MtgCardLegalities]
    ADD CONSTRAINT [DF_MtgCardLegalities_UpdatedOn] DEFAULT (getdate()) FOR [UpdatedOn];


GO
PRINT N'Creating [dbo].[DF_MtgCardSets_CreatedBy]...';


GO
ALTER TABLE [dbo].[MtgCardSets]
    ADD CONSTRAINT [DF_MtgCardSets_CreatedBy] DEFAULT (suser_name()) FOR [CreatedBy];


GO
PRINT N'Creating [dbo].[DF_MtgCardSets_CreatedOn]...';


GO
ALTER TABLE [dbo].[MtgCardSets]
    ADD CONSTRAINT [DF_MtgCardSets_CreatedOn] DEFAULT (getdate()) FOR [CreatedOn];


GO
PRINT N'Creating [dbo].[DF_MtgCardSets_UpdatedBy]...';


GO
ALTER TABLE [dbo].[MtgCardSets]
    ADD CONSTRAINT [DF_MtgCardSets_UpdatedBy] DEFAULT (suser_name()) FOR [UpdatedBy];


GO
PRINT N'Creating [dbo].[DF_MtgCardSets_UpdatedOn]...';


GO
ALTER TABLE [dbo].[MtgCardSets]
    ADD CONSTRAINT [DF_MtgCardSets_UpdatedOn] DEFAULT (getdate()) FOR [UpdatedOn];


GO
PRINT N'Creating [dbo].[DF_MtgCardSubtypes_CreatedBy]...';


GO
ALTER TABLE [dbo].[MtgCardSubtypes]
    ADD CONSTRAINT [DF_MtgCardSubtypes_CreatedBy] DEFAULT (suser_name()) FOR [CreatedBy];


GO
PRINT N'Creating [dbo].[DF_MtgCardSubtypes_CreatedOn]...';


GO
ALTER TABLE [dbo].[MtgCardSubtypes]
    ADD CONSTRAINT [DF_MtgCardSubtypes_CreatedOn] DEFAULT (getdate()) FOR [CreatedOn];


GO
PRINT N'Creating [dbo].[DF_MtgCardSubtypes_UpdatedBy]...';


GO
ALTER TABLE [dbo].[MtgCardSubtypes]
    ADD CONSTRAINT [DF_MtgCardSubtypes_UpdatedBy] DEFAULT (suser_name()) FOR [UpdatedBy];


GO
PRINT N'Creating [dbo].[DF_MtgCardSubtypes_UpdatedOn]...';


GO
ALTER TABLE [dbo].[MtgCardSubtypes]
    ADD CONSTRAINT [DF_MtgCardSubtypes_UpdatedOn] DEFAULT (getdate()) FOR [UpdatedOn];


GO
PRINT N'Creating [dbo].[DF_MtgCardSupertypes_CreatedBy]...';


GO
ALTER TABLE [dbo].[MtgCardSupertypes]
    ADD CONSTRAINT [DF_MtgCardSupertypes_CreatedBy] DEFAULT (suser_name()) FOR [CreatedBy];


GO
PRINT N'Creating [dbo].[DF_MtgCardSupertypes_CreatedOn]...';


GO
ALTER TABLE [dbo].[MtgCardSupertypes]
    ADD CONSTRAINT [DF_MtgCardSupertypes_CreatedOn] DEFAULT (getdate()) FOR [CreatedOn];


GO
PRINT N'Creating [dbo].[DF_MtgCardSupertypes_UpdatedBy]...';


GO
ALTER TABLE [dbo].[MtgCardSupertypes]
    ADD CONSTRAINT [DF_MtgCardSupertypes_UpdatedBy] DEFAULT (suser_name()) FOR [UpdatedBy];


GO
PRINT N'Creating [dbo].[DF_MtgCardSupertypes_UpdatedOn]...';


GO
ALTER TABLE [dbo].[MtgCardSupertypes]
    ADD CONSTRAINT [DF_MtgCardSupertypes_UpdatedOn] DEFAULT (getdate()) FOR [UpdatedOn];


GO
PRINT N'Creating [dbo].[DF_MtgCardTypes_CreatedBy]...';


GO
ALTER TABLE [dbo].[MtgCardTypes]
    ADD CONSTRAINT [DF_MtgCardTypes_CreatedBy] DEFAULT (suser_name()) FOR [CreatedBy];


GO
PRINT N'Creating [dbo].[DF_MtgCardTypes_CreatedOn]...';


GO
ALTER TABLE [dbo].[MtgCardTypes]
    ADD CONSTRAINT [DF_MtgCardTypes_CreatedOn] DEFAULT (getdate()) FOR [CreatedOn];


GO
PRINT N'Creating [dbo].[DF_MtgCardTypes_UpdatedBy]...';


GO
ALTER TABLE [dbo].[MtgCardTypes]
    ADD CONSTRAINT [DF_MtgCardTypes_UpdatedBy] DEFAULT (suser_name()) FOR [UpdatedBy];


GO
PRINT N'Creating [dbo].[DF_MtgCardTypes_UpdatedOn]...';


GO
ALTER TABLE [dbo].[MtgCardTypes]
    ADD CONSTRAINT [DF_MtgCardTypes_UpdatedOn] DEFAULT (getdate()) FOR [UpdatedOn];
...
GO
PRINT N'Creating [dbo].[FK_MtgCardColors_Color]...';


GO
ALTER TABLE [dbo].[MtgCardColors]
    ADD CONSTRAINT [FK_MtgCardColors_Color] FOREIGN KEY ([ColorId]) REFERENCES [Codes].[Color] ([ColorId]);
