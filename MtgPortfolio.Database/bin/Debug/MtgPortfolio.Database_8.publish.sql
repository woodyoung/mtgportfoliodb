...
GO
PRINT N'Dropping [Codes].[UQ_Format_Code]...';


GO
ALTER TABLE [Codes].[Format] DROP CONSTRAINT [UQ_Format_Code];
...
GO
ALTER TABLE [Codes].[Format] ALTER COLUMN [Code] VARCHAR (50) NOT NULL;
