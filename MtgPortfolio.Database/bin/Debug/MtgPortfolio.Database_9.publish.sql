...
GO
PRINT N'Dropping [Codes].[UQ_Subtype_Code]...';


GO
ALTER TABLE [Codes].[Subtype] DROP CONSTRAINT [UQ_Subtype_Code];


GO
PRINT N'Altering [Codes].[Subtype]...';


GO
ALTER TABLE [Codes].[Subtype] ALTER COLUMN [Code] VARCHAR (50) NOT NULL;
